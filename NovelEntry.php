...
if (isset($_POST['submit'])) {
    ...
    $target = "novel/" . basename($_FILES['image']['name']);
   ...
   include("db.php");
    ...
    if ($mysqli->query("insert into novel (name, image,author_name,price,quantity) VALUES ('$name','$image','$author_name',
      '$price',' $quantity')")) {
...
<div id="upload">
<div id="add"> <h2 >Entry Your Novel Books</h2></div><br>
<div id="name">
</br></div>
<div id="name">
    ...
    while ($row=mysqli_fetch_array($result)) {
      $name="";
              ?>
                ...
                <img src="<?php echo 'novel/'.$row['image']?>"> <br>
                <?PHP
                      echo  $row['name'] ;
                    $name=$row['name'];
                    echo "&nbsp &nbsp"; 
                    ...
                    <div>
                      ...
                      <a href="NovelBookDetail.php?name=<?php echo $name ?>">ClickMe</a>
                    </div>
