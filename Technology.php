...
?> 
   ...
   <div id="heading"><h1><em>Technology Books</em></h1> </div>
...
<div>
   ...
   <?php
   $sql=mysql_query("select * from technology");
    ...
    while ($row=mysql_fetch_array($sql)) {
              ...
              <table id="change">
                 <div >
                 <tr> <td>
                <img src="<?php echo 'technology/'.$row['image']?>"> 
                ...
                <?PHP
                    ...
                    <div>
                      ...
                      <a href="TechnologyBookDetail.php?name=<?php echo $name ?>&email=<?php echo $email ?>">ClickMe</a>
                    </div>
                   </td> </tr> 
                    <?PHP  
