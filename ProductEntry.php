...
if (isset($_POST['submit'])) {
   ...
   include("db.php");
    ...
    if ($mysqli->query("insert into book (name, image,author_name,price,quantity) VALUES ('$name','$image','$author_name'
      ,'$price',' $quantity')")) {
...
<div id="upload">
<div id="add"> <h2>Entry Your Product</h2></div><br>
<div id="name">
</br></div>
<div id="name">
...
<input type="text" name="price" placeholder="Enter the book price">  &nbsp &nbsp &nbsp &nbsp
</br>
<br>
    ...
    while ($row=mysqli_fetch_array($result)) {
      $name="";
              ?>
                ...
                <img src="<?php echo 'img/'.$row['image']?>"> <br>
                ...
                <?PHP
                    ...
                    <div>
                      ...
                      <a href="singlebookdetail.php?name=<?php echo $name ?>">ClickMe</a>
                    </div>
