...
if (isset($_POST['submit'])) {
    ...
    $target = "deepaknayer/" . basename($_FILES['image']['name']);
   ...
   include("db.php");
    ...
    if ($mysqli->query("insert into deepaknayer (name, image,author_name,price,quantity) VALUES ('$name','$image','$author_name'
      ,'$price',' $quantity')")) {
...
<div id="upload">
<div id="add"> <h2 >Entry Deepaknayer's Books</h2></div><br>
<div id="name">
</br></div>
<div id="name">
   ...
   <?php
    ...
    while ($row=mysqli_fetch_array($result)) {
              ?>
                ...
                <img src="<?php echo 'deepaknayer/'.$row['image']?>"> <br>
                <?PHP
                    ...
                    <div>
                      ...
                      <a href="DeepakNayerBookDetail.php?name=<?php echo $name ?>">ClickMe</a>
                    </div>
