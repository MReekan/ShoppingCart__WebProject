...
if (isset($_POST['submit'])) {
    ...
    $target = "it/" . basename($_FILES['image']['name']);
   ...
   include("db.php");
    ...
    if ($mysqli->query("insert into it (name, image,author_name,price,quantity) VALUES ('$name','$image','$author_name',
      '$price',' $quantity')")) {
   ...
   <?php
    ...
    while ($row=mysqli_fetch_array($result)) {
              ?>
                ...
                <img src="<?php echo 'it/'.$row['image']?>"> <br>
                <?PHP
                        echo  $row['name'] ;
                    $name=$row['name'];
                    echo "&nbsp &nbsp"; 
                    ...
                    <div>
                      ...
                      <a href="ItBookDetail.php?name=<?php echo $name ?>">ClickMe</a>
                    </div>
