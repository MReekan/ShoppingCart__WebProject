...
?> 
   ...
   <div id="heading"><h1><em>Kannathasan's Books</em></h1> </div>
...
<div>
   ...
   <?php
   $sql=mysql_query("select * from kannathasan");
    ...
    while ($row=mysql_fetch_array($sql)) {
              ...
              <table id="change">
                 <div >
                 <tr> <td>
                <img src="<?php echo 'kannathasan/'.$row['image']?>"> 
                ...
                <?PHP
                    ...
                    <div>
                      ...
                      <a href="KannathasanBookDetail.php?name=<?php echo $name ?>&email=<?php echo $email ?>">ClickMe</a>
                    </div>
                   </td> </tr> 
                    <?PHP  
