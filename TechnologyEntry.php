...
if (isset($_POST['submit'])) {
    ...
    $target = "technology/" . basename($_FILES['image']['name']);
   ...
   include("db.php");
    ...
    if ($mysqli->query("insert into technology (name, image,author_name,price,quantity) VALUES ('$name','$image','$author_name', '$price',' $quantity')")) {
...
<div id="upload">
<div id="add"> <h2>Entry Your Technology Books</h2></div><br>
<div id="name">
</br></div>
<div id="name">
   ...
   <?php
    ...
    while ($row=mysqli_fetch_array($result)) {
              ?>
                ...
                <img src="<?php echo 'technology/'.$row['image']?>"> <br>
                <?PHP
                   echo  $row['name'] ;
                    $name=$row['name'];
                    echo "&nbsp &nbsp"; 
                    ...
                    <div>
                      ...
                      <a href="TechnologyBookDetail.php?name=<?php echo $name ?>">ClickMe</a>
                    </div>
