...
?> 
   ...
   <div id="heading"><h1><em>Novel Books</em></h1> </div>
...
<div>
   ...
   <?php
   $sql=mysql_query("select * from novel");
    ...
    while ($row=mysql_fetch_array($sql)) {
              ...
              <table id="change">
                 <div >
                 <tr> <td>
                <img src="<?php echo 'novel/'.$row['image']?>"> 
                ...
                <?PHP
                    ...
                    <div>
                      ...
                      <a href="NovelBookDetail.php?name=<?php echo $name ?>&email=<?php echo $email ?>">ClickMe</a>
                    </div>
                   </td> </tr> 
                    <?PHP  
