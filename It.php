...
?> 
   ...
   <div id="heading"><h1><em>It Books</em></h1> </div>
...
<div>
   ...
   <?php
   $sql=mysql_query("select * from it");
              ...
              <table id="change">
                ...
                <?PHP
                    ...
                    <div>
                      ...
                      <a href="ItBookDetail.php?name=<?php echo $name ?>&email=<?php echo $email ?>">ClickMe</a>
                    </div>
                   </td> </tr> 
                    <?PHP  
